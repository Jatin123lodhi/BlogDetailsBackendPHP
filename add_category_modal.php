        ...
        <div class="relative p-4 w-full max-w-2xl max-h-full">
            ...
            <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                ...
                <div class="p-4 md:p-5 space-y-4 ">
                    <form action="insert_category_data.php" method="post" class="px-[2%]">
                         
                        <div class="flex flex-col ">
                            <label class="text-lg">New Category</label>
                            <input required type="name" name="name" class="border border-gray-400 p-2 " />
                        </div>
                         
                        <input type="submit" class="cursor-pointer bg-green-400 p-2 px-4 rounded-lg text-white mt-4" name="add_category" value="Add" />
